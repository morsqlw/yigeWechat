;(function( $, window ){
    ...
    PageSlider.prototype.moveNext = function( isAuto ){
        ...
        switch(curPage + 1) {
        	case 1:
        	$('.screen-two .text-left .title').css('left', 0);
        	$('.screen-two .text-left').css('left', 0);
        	break;
        	case 2:
        	$('.screen-three .text-right').css('right', 0);
        	break;
        	case 3:
        	$('.screen-four .text-right').css('right', 0);
        	break;
        }
    };
